...
public class SoundManager : MonoBehaviour
{
    ...
    public List<AudioSource> ZombieChase;
    public AudioSource GetChaseSound => ZombieChase[Random.Range(0, ZombieChase.Count)]; //Get random sound from zombie chase list
    ...
    public void ToggleMusic()
    {
        ...
        MusicOn.SetActive(!MuteMusic.isOn);
        MusicOff.SetActive(MuteMusic.isOn);
    ...
    public void ToggleSFX()
    {
        ...
        SFXOn.SetActive(!MuteSFX.isOn);
        SFXOff.SetActive(MuteSFX.isOn);
